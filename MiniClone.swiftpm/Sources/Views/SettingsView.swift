    ...
    var body: some View {
        NavigationView {
            Form {
                ...
                Section(header: Text("Appearance"), footer: Text("Pick a color system that matches your mood. Changes apply across MiniClone immediately.")) {
                ...
                Section(header: Text("Diagnostics")) {
                    NavigationLink(destination: OCRDebugView()) {
                        HStack {
                            Image(systemName: "eye.trianglebadge.exclamationmark")
                            Text("Inspect OCR Index")
                        }
                    }
                }
