...
struct MiniCloneView: View {
    ...
    init(note: NoteItem, initialPageIndex: Int? = nil) {
        self.note = note
        self.initialPageIndex = initialPageIndex
        _viewModel = StateObject(wrappedValue: CanvasViewModel(noteId: note.id, initialPageIndex: initialPageIndex))
    }
    ...
    var body: some View {
        GeometryReader { geometry in
            ...
            .onDisappear {
                // Re-index this note via Vision OCR whenever the user leaves the editor.
